            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        <li class="active"><a href="shopBrico">Bricolage</a></li>
                        <li><a href="shopJard">Jardinage</a></li>
                        <li><a href="ShopEngin">Engin de chantier</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                <img src="image/marteaupiqueur.jpg" alt="">
                                <!-- Hover Thumb -->
                            </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    <div class="line"></div>
                                    <p class="product-price">96€</p>
                                    <a href="product-details.php">
                                        <h6>Marteau-piqueur avec broches</h6>
                                    </a>
                                </div>
                                <!-- Ratings & Cart -->
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="image/marteau_piqueur.jpg" alt="">
                                <!-- Hover Thumb -->
                            </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single_widget_area">
                        ...
                        <div class="footer-logo mr-50">
                            <a href="index.html"><img src="imgage/roilles.PNG" alt=""></a>
                        </div>
                        <!-- Copywrite Text -->
